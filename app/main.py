...
async def home(request: Request):
    ...
    return templates.TemplateResponse(
        "index.html",
        {"request": request, "default_zip_code": default_zip, **get_system_info()},
    )


@app.post("/weather", response_class=HTMLResponse)
async def get_weather_recommendations(request: Request, zip_code: str = Form(...)):
    ...
    try:
        ...
        print(
            f"✅ Recommendations received: {len(recommendations) if recommendations else 0} chars"
        )
